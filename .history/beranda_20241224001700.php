...
<body>
    ...
    <div class="loginAkun-btn">
        <?php if ($_SESSION['role'] === 'admin'): ?>
            <a href="Admin/profile_admin.php"><img src="gambar/icons8-user-100.png" id="profil-icon" alt=""></a> <!-- Tautan ke profil admin -->
        <?php elseif ($_SESSION['role'] === 'penulis'): ?>
            <a href="tes/profile.php"><img src="gambar/icons8-user-100.png" id="profil-icon" alt=""></a> <!-- Tautan ke profil penulis -->
        <?php endif; ?>
    </div>
        <?php else: ?>
    ...
    <div class="grid-conten">
        ...
        <div class="semua-berita-btn">
            <div class="card-btn-semua-berita">
                <button class="semua-berita-btn">SEMUA BERITA</button>
            </div>
        </div>
