  ...
  <div class="container">
    ...
    <h3>Dashboard</h3>
      <ul>
        ...
        <li class="profil"><a href="verifikasi_artikel.php">Verifikasi Artikel</a></li>
        <li class="profil"><a href="hapus_artikel_admin.php">Hapus Artikel</a></li>
        <li class="profil"><a href="daftar_akun.php">Daftar Akun</a></li>
        <li class="profil"><a href="form_penulis.php">Formulir Penulis</a></li>
        <li class="profil"><a href="Tambah_admin.php">Tambah Artikel</a></li>
        <li class="profil"><a href="edit_artikel_admin.php">Edit Artikel</a></li>
        <li class="profil"><a href="artikel_saya_admin.php">Semua Artikel</a></li>
      </ul>
